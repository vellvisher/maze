...
public class Server implements ServerApi {
    ...
    private static final WAITING_PERIOD = 20000;
    ...
    private List<Player> syncPlayers =
        new Collections.synchronizedList(new ArrayList<Player>());
    ...
    public Reply joinGame() {
        ...
        return new Reply(treasures, p, syncPlayers, Status.JOIN_SUCCESSFUL);
    }
	...
	try {
	    ...
	    stub = (ServerApi) UnicastRemoteObject.exportObject(obj, DEFAULT_PORT);
